import { BangloanFixedYieldVaultWithUpside, BangloanFixedYieldVaultWithUpside__factory } from '@bangloan/contracts';
...
export class UpdateUpsideTwapService {
  ...
  private async contract(addr: string): Promise<BangloanFixedYieldVaultWithUpside> {
    return BangloanFixedYieldVaultWithUpside__factory.connect(addr, await this.ethers.operator());
  }
}
